...
const About = () => {
  ...
  <div className="hero-content flex-col-reverse lg:flex-row">
    <img src={"https://i.ibb.co/k87kwm7/pablo-heimplatz-ZODc-Bk-Eohk8-unsplash.jpg"} alt="" />
    <div>
      <h1 className="text-5xl font-bold">About Us !</h1>
      <p className="py-6">
Corporate Elite Events is a premier event management company specializing in the seamless execution of corporate events. With a passion for creativity and a commitment to excellence, we have been transforming corporate gatherings into unforgettable experiences for over a decade.
</p>
<p>
Our Mission:
